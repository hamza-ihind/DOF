  ...
  return (
    <div>
      ...
      <div className="w-full bg-slate-200 h-1.5 overflow-hidden">
        <div className="bg-[#0a4f6c] h-full w-full" />
      </div>
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-sm space-y-6">
                <div className="border-b border-slate-100 pb-3 flex items-center justify-between">
                  ...
                  <Sparkles className="w-5 h-5 text-[#0a4f6c]" />
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {contributingMembers.map((member) => (
                      <div key={member.id} className="flex items-center gap-2 p-2 rounded-xl bg-slate-50 border border-slate-100">
                        {/* Circle Photo */}
                        <div className="relative w-8 h-8 rounded-full overflow-hidden shrink-0 border border-white shadow-sm bg-slate-200">
                          <Image
                            src={member.photoUrl}
                            alt={member.name}
                            fill
                        ...
                        <span className="text-xs font-bold text-[#0a4f6c] truncate">
                          {member.name}
                        </span>
                      </div>
                    ))}
